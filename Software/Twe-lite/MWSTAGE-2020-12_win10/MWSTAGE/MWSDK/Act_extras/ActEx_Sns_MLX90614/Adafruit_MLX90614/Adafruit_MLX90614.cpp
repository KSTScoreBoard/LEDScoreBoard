...
/**
 * @brief Get the current temperature as 100x int16_t value.
 *
 * @return int16_t 100x temperature value
 */
int16_t Adafruit_MLX90614::readTemp100(uint8_t reg) {
  int temp;
...
/**
 * @brief Get the ambient temperature as 100x int16_t value.
 *
 * @return int16_t 100x temperature value
 */
int16_t Adafruit_MLX90614::readObjectTempC100(void) {
  return readTemp100(MLX90614_TOBJ1);
}
 ...
 * @return int16_t 100x temperature value
 */
int16_t Adafruit_MLX90614::readAmbientTempC100(void) {
  return readTemp100(MLX90614_TA);
}
